...
%>
<title>UpCross Selling ${pageContext.request.contextPath}</title>
<link href="${pageContext.request.contextPath}/content/css/upcross-selling.css" rel="stylesheet" type="text/css" />
