...
<link href="${pageContext.request.contextPath}/content/css/util.css" rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/content/css/boe_apps_style.css" rel="stylesheet" type="text/css" />
